class ProveedoresController < ApplicationController
  ...
  private
    ...
    def proveedore_params
      params.require(:proveedore).permit(:idProveedor, :identificacion, :nombre, :idCiudad, :idDpto, :direccion, :correo, :telefonos, :idTipoProv, :idEstadoProv, :idCategoriaProv, :comentario)
    end
end
